        ...
        index === 1 ? (
          <span key={index} className="relative whitespace-nowrap">
            ...
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute -bottom-2 left-0 h-auto w-full text-[#00D4A4]"
        ...
        >
          {integrations.map((item) => (
            <motion.div
              ...
              className="group flex items-start space-x-4 p-4 rounded-lg hover:bg-[#F8FAFC] transition-colors duration-300"
            >
