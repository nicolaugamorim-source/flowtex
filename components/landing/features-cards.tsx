            ...
            return (
              ...
              >
                <div className="relative h-96 md:h-[28rem] rounded-2xl border border-[#C8D8E6] bg-[#E8EFF5] hover:border-[#C8D8E6]/60 hover:shadow-lg transition-all duration-300 p-4 flex flex-col overflow-hidden">
                  {/* Inner card */}
                  {i === 0 ? (
                    <div className={`absolute top-1/2 -translate-y-1/2 w-1/2 h-[90%] rounded-xl border border-[#C8D8E6] bg-[#DDE6EF] flex flex-col items-center justify-center p-4 gap-4 right-6`}>
                      <div className="w-[70%] bg-white rounded-lg border border-[#C8D8E6] p-3">
                        <div className="flex items-center gap-2 mb-2">
                          <svg className="w-4 h-4 text-[#00D4A4]" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" />
                          </svg>
                          <p className="text-sm font-semibold text-[#0D1F2D]">Client Added</p>
                        </div>
                        <div className="flex justify-between items-center text-sm gap-2 mb-4">
                          <div className="flex gap-1">
                            <span className="font-medium text-[#0D1F2D]">Name:</span>
                            <span className="text-[#0D1F2D]">John</span>
                          </div>
                          <div className="flex gap-1">
                            <span className="font-medium text-[#0D1F2D]">Obs:</span>
                            <span className="text-[#0D1F2D]">None</span>
                          </div>
                        </div>
                        <p className="text-sm font-semibold text-[#0D1F2D] mb-4">Task created - Website Redesign</p>
                        <div className="flex items-center gap-2 mb-2">
                          <div className="w-5 h-5 rounded bg-blue-500 flex items-center justify-center text-white text-xs font-bold">
                            31
                          </div>
                          <p className="text-sm font-semibold text-[#0D1F2D]">Google Calendar</p>
                        </div>
                        <p className="text-sm font-semibold text-[#0D1F2D] mb-1">Kickoff Call</p>
                        <p className="text-sm text-[#0D1F2D]">Friday 02:00 PM</p>
                      </div>

                      <div className="bg-[#00D4A4] text-[#0D1F2D] rounded-lg px-3 py-3 text-sm max-w-[85%] text-center font-semibold">
                        "{feature.command}"
                      </div>
                    </div>
                  ) : (
                    <div className={`absolute top-1/2 -translate-y-1/2 w-1/2 h-[90%] rounded-xl border border-[#C8D8E6] bg-[#DDE6EF] flex flex-col items-center justify-center p-4 gap-4 ${
                      i === 1 ? 'left-6' : 'right-6'
                    }`}>
                      {/* Response Bubble */}
                      <div className="w-[75%] bg-white rounded-lg border border-[#C8D8E6] p-3">
                        {i === 1 ? (
                          <>
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <p className="text-sm font-semibold text-[#0D1F2D]">Follow up email</p>
                            </div>
                            <div className="w-full text-left">
                              <p className="text-sm font-semibold text-[#0D1F2D] mb-1">Hello John,</p>
                              <p className="text-sm text-[#0D1F2D] line-clamp-3 leading-relaxed">
                          ...
                          <>
                            <div className="flex items-center gap-2 mb-3">
                              <svg className="w-5 h-5 text-[#00D4A4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                              </svg>
                              <p className="text-sm font-semibold text-[#0D1F2D]">Report Generated</p>
                            </div>
                            <div className="w-full text-left space-y-2.5">
                              <div className="space-y-1.5">
                                <p className="text-sm font-semibold text-[#0D1F2D]">Active Projects</p>
                                <div className="flex items-center gap-3">
                                  <div className="relative w-12 h-12">
                                    <svg className="w-12 h-12 transform -rotate-90" viewBox="0 0 100 100">
                                      <circle cx="50" cy="50" r="30" fill="none" stroke="#00D4A4" strokeWidth="12" strokeDasharray="113.1 188.5" strokeLinecap="round" />
                                  ...
                                  <div className="text-sm">
                                    <p className="text-[#0D1F2D] font-semibold">5 running</p>
                                    <div className="flex flex-col gap-1 mt-1">
                                      <span className="text-xs flex items-center gap-1.5"><span className="inline-block w-2 h-2 rounded-full bg-[#00D4A4]"></span><span className="text-[#00D4A4] font-semibold">3 on track</span></span>
                              ...
                              <div className="space-y-1.5">
                                <p className="text-sm font-semibold text-[#0D1F2D]">This Week</p>
                                <p className="text-sm text-[#0D1F2D]">12 meetings scheduled: 3 stakeholder reviews, 4 team syncs, 5 client calls</p>
                              </div>
                              <div className="border-t border-[#C8D8E6] pt-2.5 mt-2">
                                <p className="text-sm text-[#0D1F2D]">
