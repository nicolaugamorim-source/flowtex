    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl border border-[#C8D8E6] p-8 md:p-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#0D1F2D] mb-2">Privacy Policy</h1>
          <p className="text-[#4A6880] mb-8">Last updated: June 2026</p>

          <div className="space-y-8 text-[#2E4A62]">
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">2. Information Collection and Use</h2>
              ...
              <h3 className="text-lg font-semibold text-[#0D1F2D] mt-4 mb-2">Types of Data Collected:</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">3. Use of Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">4. Security of Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">5. Third-Party Services</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">6. Links to Other Sites</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">7. Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">8. Changes to This Privacy Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">9. Your Rights</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">10. Contact Us</h2>
              <p className="mb-2">
            ...
            <section className="bg-[#F8FAFC] border border-[#C8D8E6] rounded-lg p-4 mt-8">
              <h3 className="font-semibold text-[#0D1F2D] mb-2">GDPR Compliance</h3>
              <p className="text-sm">
