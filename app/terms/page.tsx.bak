    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl border border-[#C8D8E6] p-8 md:p-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#0D1F2D] mb-2">Terms of Service</h1>
          <p className="text-[#4A6880] mb-8">Last updated: June 2026</p>

          <div className="space-y-8 text-[#2E4A62]">
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">1. Agreement to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">2. Use License</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">3. Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">4. Limitations</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">5. Accuracy of Materials</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">6. Links</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">7. Modifications</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">8. User Content</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">9. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#0D1F2D] mb-3">10. Contact Information</h2>
              <p>
